...
# {{ book.title }} (Scala {{ scala.version }})
...
I'm very excited to have you here and hope you will enjoy learning Scala and the ecosystem as much as I have.
...
Now, let's start the [journey](001.md) 🔥
